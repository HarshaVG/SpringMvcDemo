...
public class AjaxController {
	...
	private void iniDataForTesting() {
		...
		User user1 = new User("harsha", "pass123", "harsha@infosys.com", "012-1234567", "address 123");
		User user2 = new User("jaya", "pass456", "jaya@infosys.com", "016-7654321", "address 456");
		User user3 = new User("ananth", "pass789", "ananth@infosys.com", "012-111111", "address 789");
		users.add(user1);
		users.add(user2);
		users.add(user3);
